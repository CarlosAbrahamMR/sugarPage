                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="panel-body">
                                ...
                                @endphp
                                <div class="panel-body">
                                    <form action="/subir-img-recompensa" class="dropzone" id="my-great-dropzone" style="border:0;">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="producto" value="{{$recompensa}}">
                                        <div class="dz-default dz-message">
                                            <p class="text-muted">Sube una imagen de recompensa</p>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="col-md-12">
                                <form action="{{route('upload.img')}}" method="POST" id="form">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <input type="hidden" name="producto" value="{{$recompensa}}">
                                        <button @click="guardar()" type="submit" class="btn btn-primary">Submit</button>
